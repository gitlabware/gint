...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Reporte por Tipo de Usuario y Sucursal</h3>
            </div>
            <div class="panel-body">
                <?php echo $this->Form->create('Reporte', array('action' => 'reporte_tipo_usuario', 'data-parsley-validate')); ?>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="control-label">Desde</label>
                            <?php echo $this->Form->text('Hojasproduccione.fecha_inicio', array('class' => 'form-control', 'id' => 'fecha_p_11', 'placeholder' => 'Seleccione la fecha', 'required')); ?>
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Hasta</label>
                            <?php echo $this->Form->text('Hojasproduccione.fecha_fin', array('class' => 'form-control', 'id' => 'fecha_p_12', 'placeholder' => 'Seleccione la fecha', 'required')); ?>
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Seleccione Tipo Fecha</label>
                            <?php echo $this->Form->select('Hojasproduccione.tipo_fecha', array('DATE(Hojasproduccione.created)' => 'Fecha Produccion', 'DATE(Hojastipostrabajo.created)' => 'Fecha Hojaruta'), array('class' => 'form-control', 'required', 'value' => 'DATE(Hojasproduccione.created)')); ?>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <?php echo $this->Form->select('Hojasproduccione.user_id', $usuarios, array('class' => 'form-control', 'required', 'value' => 'Todos')); ?>
                        </div>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    $('#fecha_p_11').datepicker({dateFormat: 'yy-mm-dd'});
    $('#fecha_p_12').datepicker({dateFormat: 'yy-mm-dd'});
</script>