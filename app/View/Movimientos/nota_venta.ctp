        ...
        <div class="panel panel-primary" align="center">
            ...
            <table class="CSSTableGenerator" style="margin-top:-1px;">
                <tr>
                    ...
                    <td><?php echo $movimiento['Cliente']['nombre']; ?></td>
                    <td class="text-danger">Nit</td>
                    <td><?php echo $movimiento['Cliente']['nit']; ?></td>
                    <td class="text-danger">Telefonos</td>
                    <td><?php echo $movimiento['Cliente']['telefono'] . ' ' . $movimiento['Cliente']['celular']; ?></td>
                </tr>
            </table>
            <span class="text-success" style="font-weight: bold; font-size: 19px; margin-top: 4px; margin-bottom: 4px;" >DETALLE DE VENTA</span>
            <table class="CSSTableGenerator">
                <tr>
                ...
                <?php foreach ($insumos as $in): ?>
                    <tr>
                        ...
                        <td><?php echo $in['Inventario']['precio'] ?></td>
                    </tr>
                <?php endforeach; ?>
                <tr>
                    <td></td>
                    ...
                    <td></td>
                    <td>TOTAL</td>
                    <td><?php echo $movimiento['Movimiento']['total']; ?></td>
                </tr>
            </table>
            <table class="CSSTableGenerator" style="margin-top:-1px;">
                <tr>
