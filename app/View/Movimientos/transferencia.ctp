    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-heading">
                <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span>TRANSFERENCIA</h3>
            </div>
            <!--/ panel heading/header -->
            <div class="panel-body">
                <div class="form-horizontal form-striped form-bordered">
                    <?php echo $this->Form->create('Movimiento', array('action' => 'registra_transferencia', 'id' => 'idformventa')); ?>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Transferir a</label>
                        <div class="col-sm-8">
                            <?php echo $this->Form->select('tsucursale_id', $sucursales, array('class' => 'form-control', 'required', 'data-parsley-group' => 'gventa')) ?>
...
<?php endforeach; ?>
    function iniventana() {
        $('#idselectcategoria').change(function () {
            ...
            $('#divajaxinsumo').load('<?php echo $this->Html->url(array('action' => 'ajax_form_insumo')); ?>/' + idcategoria + '/1');
        });
    }
...
<?php if (!empty($this->request->data['Insumos'])): ?>
            $('#divajaxinsumo').load('<?php echo $this->Html->url(array('action' => 'ajax_form_insumo')); ?>/' + 0 + '/1');
