                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($hojas_tra as $ht): ?>
                                        ...
                                        <?php echo $this->Form->hidden("Hojasproduccione.$i.caras", array('value' => $ht['Hojastipostrabajo']['caras'])); ?>
...
<?php endforeach; ?>
    ...
    function calcula_costo1(numero, sw) {
        ...
        //-------------------------
        if (!sw) {
            $('#idcosto-' + numero).val(parseFloat((vcantidad * vancho * valto * vprecio).toFixed(2)));
        }
        suma_total();
    }
        ...
        if (sw == 2) {
            if ($('#idpreciose-' + numero).val() != '') {
                if (vcantidad <= precios2[$('#idpreciose-' + numero).val()]['cantidadfinal']) {
                    vprecio = precios2[$('#idpreciose-' + numero).val()]['precio'];
                } else {
                    vprecio = (precios2[$('#idpreciose-' + numero).val()]['precio'] / precios2[$('#idpreciose-' + numero).val()]['cantidadfinal']) * vcantidad;
                }
            }
        ...
        if (sw == 2) {
            if ($('#idpreciose-' + numero).val() != '') {
                if (vcantidad <= precios4[$('#idpreciose-' + numero).val()]['cantidadfinal']) {
                    vprecio = precios4[$('#idpreciose-' + numero).val()]['precio'];
                } else {
                    vprecio = (precios4[$('#idpreciose-' + numero).val()]['precio'] / precios4[$('#idpreciose-' + numero).val()]['cantidadfinal']) * vcantidad;
                }
            }
            vprecio = parseFloat(vprecio.toFixed(2));
            $('#idprecio-' + numero).val(vprecio);
