<div class="modal-header text-center">
    ...
    <div class=" ico-calculate2 mb15 mt15" style="font-size:36px;"><h3 class="semibold modal-title text-info">Guillotina cortes</h3></div>

</div>
<?php echo $this->Form->create('Formato', array('action' => 'guardaformato', 'data-parsley-validate')); ?>
<div class="modal-body">
    <?php echo $this->Form->hidden('id'); ?>
    <?php echo $this->Form->hidden('url', array('value'=>'lista15')); ?>
    <?php echo $this->Form->hidden('tipotrabajo_id', array('value'=>15)); ?>
<div class="form-group">
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-sm-6">
                <label class="control-label">Numero cortes</label>
                <?php echo $this->Form->text('numero_cortes', array('class' => 'form-control', 'placeholder' => 'Ingrese', 'data-parsley-type'=>'number','required')); ?>
            </div>
         <div class="col-sm-6">
