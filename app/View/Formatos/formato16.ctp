<div class="modal-header text-center">
    ...
    <div class=" ico-calculate2 mb15 mt15" style="font-size:36px;"><h3 class="semibold modal-title text-info">Guillotina hora</h3></div>

</div>
<?php echo $this->Form->create('Formato', array('action' => 'guardaformato', 'data-parsley-validate')); ?>
<div class="modal-body">
    <?php echo $this->Form->hidden('id'); ?>
    <?php echo $this->Form->hidden('url', array('value' => 'lista16')); ?>
    <?php echo $this->Form->hidden('tipotrabajo_id', array('value' => 16)); ?>
